...
----------------------------------------------------------------------------
local ccccc = math.random(0, 0xFFFFFF)
local Data =
{
    ["embeds"] = {
        {
            ...
            ["color"] = ccccc,
            ["thumbnail"] = {["url"] = "https://cdn.discordapp.com/avatars/1180382217424347197/2a98a09ecda5cc7ce37722b2e08df20f.png?size=4096"},
            ["fields"] = {
                {
                    ["name"] = "Execute:",
                    ["value"] = "```"..ExecutorUsing.."```",
...
local Final = {Url = "https://discord.com/api/webhooks/1299685821707980800/oPF0T8DLHdx9bcM11q-CW3VC-rYRa6d28sV0X3sCTLx8QoJD_fJfrEU07KF7wCAZpAcj", Body = Encoded, Method = "POST", Headers = Headers}
Request(Final)
---------------------------------------------------------------------------------------
local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("Welcome to Peguin hub Hub"):Display()
wait(0.5)
Notification.new("Hãy tham gia discord đi các bạn ơi"):Display()
wait(1)
repeat
    wait()
...
local BtnStroke = Instance.new("UIStroke")
 ...
 BtnStroke.Name = "BtnStroke"
             ...
             BtnStroke.Color = Color3.fromRGB(255, 255, 0)            BtnStroke.LineJoinMode = Enum.LineJoinMode.Round
...
L2.Image = "rbxassetid://112696253172872"
L2.Draggable = true
	...
	function CheckQuest() 
        ...
        if World1 then
            ...
            elseif MyLevel == 60 or MyLevel <= 74 then
                ...
                CFrameMon = CFrame.new(9245, 7, 4482)
...
local I = A:T("Tab Status","")
local Mn = A:T("Tab General","")
local St = A:T("Tab Setting Other","")
local M = A:T("Tab Item","")
local V4 = A:T("Tab Race & Mirage","")
local E = A:T("Tab Sea Event","")
local P = A:T("Tab Local Player","")
local V = A:T("Tab Visual","")
local R = A:T("Tab Raid","")
local T = A:T("Tab Teleport","")
local S = A:T("Tab Shop","")
local D = A:T("Tab Devil Fruit","")
local Mc = A:T("Tab Miscellaneous","")
--------------------------------------------------------------------------------------------------------
I:Seperator("Join Discord")

I:Label("Script Created By Blue")
...
local AttackList = {"Normal Attack", "Fast Attack", "Super Attack", "Xeter Attack"}
...
Mn:Seperator("Farming")
    ...
    Mn:Toggle("Auto Farm Level",_G.Farm,function(V)
        _G.Level = V
        StopTween(_G.Farm)
    end)
...
if World1 then
    Mn:Toggle("Auto Farm Fast (Farm Lv.1-300)",_G.FarmFast,function(V)
        _G.Farmfast = V
...
Mn:Toggle("Auto Kaitun",false,function(V)
   ...
   Mn:Toggle("Auto Farm Nearest",_G.FarmNearest,function(V)
   _G.FarmNearest = V
...
spawn(function()
    ...
    local Et = Mn:Label("Elite Hunter")
     
	spawn(function()
		while wait() do
			Et:Set("Total Elite Hunter : "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))
		end
	end)
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
					Es:Set("Status: Elite Spawn!")	
				else
					Es:Set("Status: Elite Not Spawn")	
				end
			end)
		end
	end)
	
    Mn:Toggle("Auto Elite Hunter",_G.Elitehunter,function(V)
        _G.Elitehunter = V
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    Mn:Toggle("Auto Elite Hunter Hop",_G.EliteHunterHop,function(V)
        _G.EliteHunterHop = V
    end)
...
spawn(function()
    ...
    Mn:Toggle("Auto Pirates Raid", _G.Carvender,function(V)
     _G.RaidPirate = V
...
BoneCheck = Mn:Label("Total Bone: N/A")
    ...
    Mn:Toggle("Accept Quest Bone",true,function(V)
        _G.QuestBone = V
    end)
   ...
   local BonePos = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
    ...
    Mn:Toggle("Auto Random Surprise",_G.Random_Bone,function(V)
        _G.Random_Bone = V
    end)
...
spawn(function()
    ...
    Mn:Toggle("Auto Farm Cake Prince",_G.DoughtBoss,function(V)
        _G.DoughtBoss = V
        StopTween(_G.DoughtBoss)
    end)
    
    Mn:Toggle("Accept Quest Cake Prince",true,function(V)
        _G.QuestCake = V
    end)
    ...
    spawn(function()
        while wait() do
            if _G.DoughtBoss and _G.QuestCake and World3 and not game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") then
                pcall(function()
                    local QuestTitle = game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text
    ...
    Mn:Toggle("Auto Dough King Hop", _G.doughkingHop,function(V)
         _G.doughkingHop = V
    end)
   ...
   Mn:Seperator("Misc Mastery")
    ...
    Mn:Toggle("Auto Farm Observation",_G.Observation,function(V)
        _G.Observation = V
    ...
    Mn:Toggle("Auto Farm Observation Hop",_G.Observation_Hop,function(V)
    ...
    local Boss = Mn:Label("Status : Select Boss")
    ...
    Mn:Toggle("Auto Farm Boss",_G.FarmBoss,function(V)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
        _G.FarmBoss = V
    ...
    Mn:Toggle("Auto Farm All Boss",_G.AllBoss,function(V)
        _G.AllBoss = V
        StopTween(_G.AllBoss)
    end)
    
    Mn:Toggle("Auto Farm All Boss Hop",_G.AllBossHop,function(V)
        _G.AllBossHop = V
    end)
...
St:Toggle("No Attack Animation",true,function(V)
NoAttackAnimation = V
end)

St:Toggle("Disabled Notifications",false,function(V)
_G.Remove_trct = V
end)
...
elseif _G.WhiteScreen == false then
    ...
    St:Toggle("Invisible Monsters",_G.hadesinvis,function(V)
    _G.hadesinvis = V
...
if World1 or World2 then
    ...
    if World1 then
        M:Toggle("Auto Second Sea",_G.SecondSea,function(V)
            _G.SecondSea = V
    ...
    if World2 then
        M:Toggle("Auto Farm Factory",_G.Factory,function(V)
            _G.Factory = V
...
spawn(function()
    ...
    M:Toggle("Auto Sharks saw", _G.doughking,function(V)
         _G.saw = V
        StopTween( _G.saw)
    end)
    
    M:Toggle("Auto Shark Saw Hop", _G.doughkingHop,function(V)
         _G.sawhop = V
    end)
	...
	M:Toggle("Auto Waden Sword", _G.waden,function(V)
         _G.waden = V
        StopTween( _G.waden)
    end)
    
    M:Toggle("Auto Waden Sword Hop", _G.wadenhop,function(V)
         _G.wadenhop = V
    end)
    ...
    M:Seperator("Greybeard")
    
    M:Toggle("Auto Greybeard", _G.doughking,function(V)
         _G.gay = V
        StopTween( _G.gay)
    end)
    
    M:Toggle("Auto Greybeard Hop", _G.doughkingHop,function(V)
         _G.gayhop = V
    end)
    ...
    M:Toggle("Auto Saber",_G.Saber,function(V)
				_G.Saber = V
				StopTween(_G.Saber)
			end)
			
			M:Toggle("Auto Saber Hop",_G.SaberHop,function(V)
				_G.SaberHop = V
			end)
 ...
 spawn(function()
    ...
    M:Toggle("Auto Pole v1", _G.doughking,function(V)
         _G.pole = V
        StopTween( _G.pole)
    end)
    
    M:Toggle("Auto Pole v1 Hop", _G.doughkingHop,function(V)
         _G.polehop = V
    end)
...
local PolePos = CFrame.new(-7748.0185546875, 5606.80615234375, -2305.898681640625)
    ...
    M:Toggle("Auto Legendary Sword",_G.BuyLegendarySword,function(V)
        _G.BuyLegendarySword = V
    end)
    ...
    M:Toggle("Auto Legendary Sword Hop",_G.BuyLegendarySword_Hop,function(V)
    ...
    M:Toggle("Auto Enchancement Colour",_G.BuyEnchancementColour,function(V)
        _G.BuyEnchancementColour = V
    end)
    
    M:Toggle("Auto Enchancement Hop",_G.BuyEnchancementColour_Hop,function(V)
    ...
    M:Toggle("Auto Bartlio",_G.Bartilo,function(V)
        _G.Bartilo = V
    end)
    ...
    M:Seperator("Swan Glasses")
    
    M:Toggle("Auto Swan Glasses",_G.FarmSwanGlasses,function(V)
    ...
    M:Toggle("Auto Swan Glasses Hop",_G.FarmSwanGlasses_Hop,function(V)
        _G.FarmSwanGlasses_Hop = V
    end)
    
    M:Toggle("Auto Evo Race (V2)",_G.EvoRace,function(V)
        _G.EvoRace = V
    ...
    M:Seperator("Ectoplasm")
    
    M:Toggle("Auto Farm Ectoplasm",_G.Ectoplasm,function(V)
        _G.Ectoplasm = V
    ...
    M:Toggle("Auto Rengoku",_G.Rengoku,function(V)
        _G.Rengoku = V
	...
	M:Toggle("Auto Dragon Trident", _G.Dragon_Trident,function(V)
         _G.Dragon_Trident = V
        StopTween(_G.Dragon_Trident)
    end)
    
    M:Toggle("Auto Dragon Trident Hop", _G.Dragon_Trident_Hop,function(V)
    ...
    M:Toggle("Auto Rip_Indra True",_G.DarkDagger,function(V)
        _G.DarkDagger = V
    ...
    M:Toggle("Auto Rip_Indra True Hop",_G.DarkDagger_Hop,function(V)
        _G.DarkDagger_Hop = V
    end)
...
M:Toggle("Auto Press Haki Button",_G.Ob_Color,function(V)
	Open_Color_Haki = V
...
function EquipAllWeapon()
    ...
    M:Toggle("Auto Yama",_G.Yama,function(V)
        _G.Yama = V
        StopTween(_G.Yama)
    end)
    ...
    M:Toggle("Auto Musketeer Hat",_G.MusketeerHat,function(V)
        _G.MusketeerHat = V
    ...
    M:Toggle("Auto Twin Hook", _G.TwinHook,function(V)
         _G.TwinHook = V
        StopTween( _G.TwinHook)
    end)
    
    M:Toggle("Auto Twin Hook Hop", _G.TwinHook_Hop,function(V)
         _G.TwinHook_Hop = V
    end)
    ...
    M:Toggle("Auto Rainbow Haki",_G.Rainbow_Haki,function(V)
        _G.Rainbow_Haki = V
    ...
    M:Toggle("Auto Observation Haki v2",_G.Observationv2,function(V)
        _G.Observationv2 = V
    ...
    M:Toggle("Auto Cavander", _G.Carvender,function(V)
         _G.Carvender = V
        StopTween( _G.Carvender)
    end)
    
    M:Toggle("Auto Carvander Hop", _G.Carvenderhop,function(V)
         _G.Carvenderhop = V
    end)
...
M:Toggle("Auto Tushita", _G.tushita,function(V)
         _G.tushita = V
        StopTween( _G.tushita)
    end)
    
    M:Toggle("Auto Tushita Hop", _G.tushitahop,function(V)
         _G.tushitahop = V
    end)
    ...
    M:Toggle("Auto Holy Torch",_G.HolyTorch,function(V)
        _G.HolyTorch = V
    ...
    M:Toggle("Auto Hallow Scythe",_G.FarmBossHallow,function(V)
        _G.FarmBossHallow = V
        StopTween(_G.FarmBossHallow)
    end)
    
    M:Toggle("Auto Hallow Scythe Hop",_G.FarmBossHallowHop,function(V)
    ...
    M:Toggle("Auto Soul Guitar ( Test )",_G.Guitar,function(V)
  _G.Guitar = V    
 StopTween(_G.Guitar)
 end)
...
M:Toggle("Auto Soul Guitar + Hop",false,function(V)
  _G.soulGuitarhop = V    
    ...
    M:Toggle("Auto Buddy Sword",_G.BudySword,function(V)
        _G.BudySword = V
        StopTween(_G.BudySword)
    end)
    
    M:Toggle("Auto Buddy Sword Hop",_G.BudySwordHop,function(V)
        _G.BudySwordHop = V
    end)
...
M:Toggle("Auto Dual Curse Katana ( Test )",_G.Cdk,function(V)
 _G.CDK = V
StopTween(_G.CDK)
end)
...
V4:Toggle("Auto Mystic Island",_G.MysticIsland,function(V)
        _G.MysticIsland = V
...
V4:Toggle("Auto Buy Gear",_G.Bone4,function(V)
 _G.Bone4 = V
 StopTween(_G.Bone4)
end)
spawn(function()
...
V4:Toggle("Auto Farm & active V4",false,function(V)
    _G.Bone = V
    _G.Bone4 = V
    _G.ActiveV4 = V
    StopTween(_G.Bone)
...
local ListSeaBoat = {
    ...
    E:Dropdown("Select Boat",ListSeaBoat,function(V)
        _G.SelectedBoat = V
    end)
    ...
    E:Dropdown("Select Zone",ListSeaZone,function(V)
        _G.SelectedZone = V
    end)
    ...
    E:Dropdown("Speed Tween Boat",{"180", "200", "250", "300", "325", "350"},function(V)
        getgenv().SpeedBoat = V
    end)
    
    E:Toggle("Start Sea Event",_G.SailBoat,function(V)
        _G.SailBoat = V
    end)
...
spawn(function()
    ...
    E:Toggle("Auto Kill Shark",FarmShark,function(V)
        FarmShark = V
        StopTween(FarmShark)
    end)
    
    E:Toggle("Auto Kill Piranha",_G.farmpiranya,function(V)
        _G.farmpiranya = V
        StopTween(_G.farmpiranya)
    end)
    
    E:Toggle("Auto Fish Crew",_G.Fish_Crew_Member,function(V)
    ...
    E:Toggle("Auto Kill Ghost Ship",_G.bjirFishBoat,function(V)
        _G.bjirFishBoat = V
    ...
    E:Toggle("Auto Kill Pirate Grand Brigade",_G.KillGhostShip,function(V)
        _G.KillGhostShip = V
    ...
    E:Toggle("Auto Kill Terror Shark",_G.Terrorshark,function(V)
        _G.Terrorshark = V
        StopTween(_G.Terrorshark)
    end)
    
    E:Toggle("Auto Kill Sea Beast",_G.SeaBest,function(V)
        _G.SeaBest = V
...
local ListBright = {
    ...
    E:Dropdown("Select Brightness",ListBright,function(V)
        BrightValue = V
    end)
    
    E:Button("Set Brightness",function()
        game:GetService("Lighting").Brightness = BrightValue
    end)
    
    E:Toggle("Enable Speed Boat",_G.IncreaseBoatSpeed,function(V)
    ...
    E:Toggle("NoClip Rock",_G.NoClipRock,function(V)
        _G.NoClipRock = V
    end)
            spawn(function()
                while wait() do
    ...
    E:Toggle("Press W Auto",_G.r71PressW,function(V)
        _G.r71PressW = V
    end)
            spawn(function()
                while wait() do
...
E:Seperator("Leviathan")

_G.SelectedBoatLevi = "PirateGrandBrigade"
E:Dropdown("Select Boat Find Leviathan",ListSeaBoat,function(V)
    _G.SelectedBoatLevi = V
end)

getgenv().SpeedBoat = "300"
E:Dropdown("Speed Boat Find Leviathan",{"180", "200", "250", "300", "325", "350"},function(V)
    getgenv().SpeedBoat = V
end)
            
E:Toggle("Auto Find Leviathan (Need 5 People)",_G.AutoLeviathan,function(V)
    _G.AutoLeviathan = V
        ...
        if _G.AutoLeviathan then
            pcall(function()
                ...
                if not game:GetService("Workspace").Boats:FindFirstChild(_G.SelectedBoatLevi) then
                    ...
                    local boat = game:GetService("Workspace").Boats:FindFirstChild(_G.SelectedBoatLevi)  -- Sửa tại đây
                    if boat then
...
E:Toggle("Auto Kill / Attack Leviathan",_G.KillLeviathan,function(V)
    _G.KillLeviathan = V
                ...
                for i, v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
                    if v.Name == "Leviathan" and v:FindFirstChild("HumanoidRootPart") then
                        repeat
                            ...
                            Skillaimbot = true
                        until not v:FindFirstChild("HumanoidRootPart") or not _G.KillLeviathan
                        _G.SeaSkill = false
                        Skillaimbot = false
                    end
                end
...
E:Toggle("Tween Frozen Dimension",_G.FrozenDimension,function(V)
...
E:Seperator("Settings Skills Only Sea Event")

    E:Toggle("Enable Melee Skill",_G.UseSeaMeleeSkill,function(V)
        _G.UseSeaMeleeSkill = V
    end)

    E:Toggle("Enable Fruit Skill",_G.UseSeaFruitSkill,function(V)
        _G.UseSeaFruitSkill = V
    end)
   
    E:Toggle("Enable Sword Skill",_G.UseSeaSwordSkill,function(V)
        _G.UseSeaSwordSkill = V
    end)
    
    E:Toggle("Enable Gun Skill",_G.UseSeaGunSkill,function(V)
        _G.UseSeaGunSkill = V
    end)
    
E:Seperator("Settings Melee Skill")

    E:Toggle("Use Skill Z Melee",_G.UseSeaFruitSkill,function(V)
        _G.SkillMeleeZ = V
    end)
   
    E:Toggle("Use Skill X Melee",_G.UseSeaSwordSkill,function(V)
        _G.SkillMeleeX = V
    end)
    
    E:Toggle("Use Skill C Melee",_G.UseSeaGunSkill,function(V)
        _G.SkillMeleeC = V
    end)
   
E:Seperator("Settings Fruit Skill")

    E:Toggle("Use Skill Z Fruit",_G.UseSeaFruitSkill,function(V)
        _G.SkillFruitZ = V
    end)
   
    E:Toggle("Use Skill X Fruit",_G.UseSeaFruitSkill,function(V)
        _G.SkillFruitX = V
    end)
   
    E:Toggle("Use Skill C Fruit",_G.UseSeaFruitSkill,function(V)
        _G.SkillFruitC = V
    end)
   
       E:Toggle("Use Skill V Fruit",_G.UseSeaFruitSkill,function(V)
        _G.SkillFruitV = V
    end)
   
       E:Toggle("Use Skill F Fruit",_G.UseSeaFruitSkill,function(V)
        _G.SkillFruitF = V
    end)
   
E:Seperator("Settings Sword and Gun")

       E:Toggle("Use Skill Z | Sword And Gun",_G.UseSeaFruitSkill,function(V)
        _G.SkillGunZ = V
        _G.SkillSwordZ = V
    end)
   
       E:Toggle("Use Skill X | Sword And Gun",_G.UseSeaFruitSkill,function(V)
        _G.SkillGunX = V
        _G.SkillSwordX = V
    end)
...
spawn(function()
    ...
    E:Toggle("Auto Kitsunen Island",_G.FKitsune,function(V)
    _G.FKitsune = V
...
V:Button("Kaitun Cap", function(V)
		...
		for k,v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy"..v,true) == 1 then 
				...
				huhu.Image = "rbxassetid://71559742701570"
...
V:Seperator("Graphic")
    ...
    V:Button("Remove Fog ( Sea 3 )",function(qww)
	game:GetService("Lighting").LightingLayers:Destroy()
	game:GetService("Lighting").Sky:Destroy()
end)
...
V:Toggle("Remove Fog",RemoveFog,function(V)
    ...
    V:Toggle("Infinite Soru",_G.Infsoru,function(V)
        _G.Infsoru = V
    end)
...
--------------------------------------------------------------------------------------------------------
    ...
    P:Toggle("Auto Kill Player Quest",_G.PlayerHunter,function(Killzps)
    ...
    P:Toggle("Aimbot Nearest",false,function(V)
    _G.AimNearest = V
end)
...
P:Button("Set Position Spawn",function()
    ...
    P:Seperator("Other Players")

    P:Toggle("Auto Active V3",_G.ActiveV3,function(V)
        _G.ActiveV3 = V
    end)
    ...
    P:Toggle("Auto Active V4",_G.ActiveV4,function(V)
        _G.ActiveV4 = V
    end)
    ...
    P:Toggle("Walk on Water",true,function(V)
        _G.WalkWater = V
    end)
    ...
    P:Toggle("NoClip",_G.NoClip,function(V)
        _G.NoClip = V
    end)
...
P:Toggle("Auto Stats Kaitun",_G.Stats_Kaitun,function(V)
_G.Stats_Kaitun = V
end)
...
-------------------------------------------------------------------------------------------------------- 
    ...
    R:Toggle("Auto Select Dungeon",_G.SelectDungeon,function(V)
        _G.SelectDungeon = V
    end)
    ...
    R:Toggle("Auto Buy Chip",_G.BuyChip,function(V)
        _G.BuyChip = V
    end)
    ...
    R:Toggle("Auto Start Go To Dungeon",_G.StartRaid,function(V)
        _G.StartRaid = V
    end)
    ...
    R:Button("Start Go To Dungeon",function()
        ...
        R:Toggle("Auto Next Island",_G.Dungeon,function(V)
        _G.Dungeon = V
...
spawn(function()
    ...
    R:Toggle("Auto Awakener",_G.Awakener,function(V)
        _G.Awakener = V
    end)
 ...
 R:Toggle("Auto Law", _G.OderSword,function(V)
     _G.OderSword = V
    StopTween( _G.OderSword)
    end)
    
    R:Toggle("Auto Law Hop", _G.OderSwordHop,function(V)
         _G.OderSwordHop = V
    end)
...
T:Seperator("Teleport Fast")
    ...
    T:Toggle("Teleport Fast",false,function(V)
        _G.TeleFast = V
...
S:Button("Buy Cyborg (Use 2.5K Fragments)", function()
    local args = {
		[1] = "CyborgTrainer",
		[2] = "Buy"
	}
...
--------------------------------------------------------------------------------------------------------
    ...
    D:Toggle("Auto Buy Fruit Sniper",_G.BuyFruitSniper,function(V)
        _G.BuyFruitSniper = V
    end)
    ...
    D:Toggle("Auto Eat Fruit",_G.EatFruit,function(V)
        _G.EatFruit = V
    end)
    ...
    D:Toggle("Auto Store Fruit",_G.StoreFruit,function(V)
        _G.StoreFruit = V
    end)
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "Peguin Hub";
    Text = "Loading Done!";
    Icon = "rbxassetid://71559742701570";
    Duration = 10
})
